...
if(isset($_GET['cve'])) {
  ...
  $domain = $_GET['domain'];
  $url = 'https://www.whoisxmlapi.com/whoisserver/WhoisService?apiKey=Your_API_KEY&outputFormat=JSON&domainName=' . $domain;
  ...
  curl_setopt($ch, CURLOPT_HTTPHEADER, array('apikey: Your_API_KEY'));
